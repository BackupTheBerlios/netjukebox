...
import form.NewContractantForm;

public class NewContractantAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping,	ActionForm form,
		...
		NewContractantForm contractantForm = (NewContractantForm)form;
		...
		boolean cree = clientXML.creerContractant(sessionLogin, nom, adresse, codepostal, ville, telephone, 
				fax, mail, type);
		
		if (cree) {
			String result = "INFO: Contractant créé";
			
			session.setAttribute("Resultat" , result);
			return mapping.findForward("ok");
		} else {
			String erreur = "ERREUR: Contractant non créé";
