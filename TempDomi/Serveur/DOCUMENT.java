...
public class DOCUMENT {
	...
	public void Creer(String Id_Doc, String Titre, int Duree, int Jour, int Mois, int Annee, String Source, String Langue, String Genre, String CheminFichier) {        
		this.Id_Doc = Id_Doc;
		this.Titre = Titre;
		this.Jour = Jour;
		this.Mois = Mois;
		...
		this.Duree = Duree;
		System.out.println("Le Document : " + Titre + " a été créé");
    } 
