...
public class EnvoiMail {	
	static String host = "smtp.aliceadsl.fr";
	static String from = "dominique.gentaz@tiscali.fr";
	public String to;
	public String Login;
	public String Nom;
	...
	public static void main (String[] args) throws AddressException, MessagingException {
		new EnvoiMail("Login1", "Nom1" ,"Prenom1" , "doumeasse38@hotmail.com", "MotDePasse", "Pays");
